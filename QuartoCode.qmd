...
1.  IMDB Movies dataset: <https://www.kaggle.com/code/nandhirajak/movie-recommendation-system>
2.  Netflix movies dataset: <https://www.kaggle.com/datasets/shivamb/netflix-shows>
3.  Disney plus movies dataset: <https://www.kaggle.com/datasets/shivamb/disney-movies-and-tv-shows>

CRAN (n.d.). *CRAN - Available Packages by Name*. Available at: <https://cran.r-project.org/web/packages/available_packages_by_name.html> \[Accessed 1 April 2024\].

Leaflet (n.d.). *Leaflet: An Open-Source JavaScript Library for Mobile-Friendly Interactive Maps*. Available at: <https://leafletjs.com/> \[Accessed 1 April 2024\].

Quarto (n.d.). *Quarto: An Open-Source Scientific and Technical Publishing System Built on Pandoc*. Available at: <https://quarto.org/> \[Accessed 1 April 2024\].

R Core Team (n.d.). *R: The R Project for Statistical Computing*. Available at: <https://www.r-project.org/> \[Accessed 1 April 2024\].

Silge, J. and Robinson, D. (n.d.). *Text Mining with R: A Tidy Approach*. Available at: <https://www.tidytextmining.com/> \[Accessed 1 April 2024\].

Wickham, H. (n.d.). *ggplot2: Elegant Graphics for Data Analysis*. Available at: <https://ggplot2.tidyverse.org/> \[Accessed 1 April 2024\].
